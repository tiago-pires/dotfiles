...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     MT(MOD_LALT,KC_MINUS),KC_A ,LT(DESIGN,KC_O) ,KC_E, KC_U, KC_I,     KC_D , KC_H  , KC_T  , KC_N , KC_S , MT(MOD_RALT,KC_SLASH), 
     MT(MOD_LSFT,KC_TAB),LT(RAISE,KC_SCLN), KC_Q  , KC_J  , KC_K  , KC_X  ,                    KC_B  , KC_M  , KC_W  , KC_V ,  KC_Z  , MT(MOD_RSFT,KC_BSLASH),
            KC_LBRC, KC_RBRC,                                                                      KC_LPRN,KC_RPRN,
           MT(MOD_LCTL,KC_TAB), MT(MOD_LSFT, KC_ESC),                                         MT(MOD_RSFT, KC_SPC), MT(MOD_RCTL,KC_ENT),
              MT(MOD_LSFT, KC_BSPC), MT(MOD_LGUI, KC_DEL),              MT(MOD_RGUI, KC_BSPC), MT(MOD_LSFT, _______), 
  ...
  [_LOWER] = LAYOUT_5x6(
     ...
     KC_0, KC_EXLM,KC_AT,KC_HASH,KC_DLR,KC_PERC,                    KC_CIRC , KC_AMPR , KC_ASTR, KC_LPRN,KC_RPRN,_______,
     KC_TILD , KC_1, KC_2 , KC_3 , KC_4 , KC_5 ,                           KC_6, KC_7 , KC_8, KC_9 ,KC_0,RCTL(KC_S),
     _______  , _______ , KC_LCBR , KC_RCBR , _______ , _______ ,     _______, LCTL(KC_6) ,RGUI(KC_BSPC), KC_RBRC ,_______ ,_______,
                        _______ , KC_0,                                            _______, _______,
                                    _______ , MT(MOD_LGUI,_______ ),                 KC_ESC,RCTL(KC_ENT),
